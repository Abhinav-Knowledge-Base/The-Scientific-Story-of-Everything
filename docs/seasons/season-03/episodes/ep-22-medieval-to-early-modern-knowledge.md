# S3E22 — Medieval to Early Modern Knowledge
...
**Phase 1 outline:** [../../season-03-the-human-story.md](../../season-03-the-human-story.md) (Episode 22)  
**Comes from:** S3E21 How Humans Keep Time (Deep Dive)  
**Goes to:** S3E23 The Scientific Revolution  
**Deepens:** S1 Ep. 31–33
...
1. Show knowledge transmission across languages and empires.
2. Credit Islamic, Indian, Chinese, and European contributions.
3. Describe universities, observatories, and craft knowledge.
4. Arrive at the brink without claiming sudden European magic.
5. Hand off to the scientific revolution proper.
...
**Cold open**  
A text travels Baghdad → Cordoba → Latin Europe—and other routes.

**Act I**  
Aristotelian and other frameworks as working worlds.

**Act II**  
Algebra, optics, medicine, astronomy exchanges.

**Act III**  
Schools, courts, workshops, observatories.

**Act IV**  
Next: Copernicus to Newton as method shift.
...
**Further depth / related:** S1E31–33 bridge; leads to S3E23.

---

## Visual set-pieces

1. Manuscript relay map
2. Observatory and workshop montage
3. Translation chain graphic
...
→ **S3E23 The Scientific Revolution**
