...
**Phase 1 outline:** [Season 3 outline](../README.md) (Episode 8)  
**Comes from:** S3E07 Out of Africa in Depth  
**Goes to:** S3E09 Language  
**Deepens:** S1 Ep. 26
...
1. Explain encephalization costs in energy terms.
2. Link long childhoods to cooperative care and teaching.
3. Sketch social-cognition bases without overclaiming.
4. Hand off to language as the cooperation transformer.
...
**Cold open**  
A large brain’s energy budget on screen.

**Act I**  
Size trends with caveats—size is not everything.

**Act II**  
Extended learning windows and alloparents.

**Act III**  
Social cognition bases for teaching and norms.

**Act IV**  
Next: language transforms cooperation.
...
**Further depth / related:** S1E26; continues to S3E09.

---

## Visual set-pieces

1. Energy-budget charts
2. Multi-age caregiving groups
3. Brain-size trend with uncertainty
