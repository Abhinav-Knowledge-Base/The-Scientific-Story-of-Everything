# S3E21 — How Humans Keep Time (Deep Dive)
...
**Phase 1 outline:** [Season 3 outline](../README.md) (Episode 21)  
**Comes from:** S3E20 Worlds of Faith and Exchange  
**Goes to:** S3E22 Medieval to Early Modern Knowledge  
**Deepens:** S1 Ep. 32
...
1. Explain lunar, solar, and lunisolar calendars.
2. Show sacred vs civil timekeeping.
3. Teach time zones and UTC offsets (+east / −west).
4. Connect clocks to navigation and coordination.
5. Hand off to medieval–early modern knowledge relay.
...
**Cold open**  
Simultaneous different dates/hours across the globe.

**Act I**  
Solar years, lunar months, intercalation problems.

**Act II**  
Ritual time binding communities.

**Act III**  
Mechanical clocks → standard time → UTC offsets.

**Act IV**  
Next: natural philosophy toward scientific revolution.
...
**Further depth / related:** S1E32 depth; leads to S3E22.

---

## Visual set-pieces

1. Globe with hour wedges
2. UTC offset dial (+east / −west)
3. Sacred calendar overlays
