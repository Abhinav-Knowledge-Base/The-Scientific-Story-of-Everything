...
**Phase 1 outline:** [../../season-04-frontiers.md](../../season-04-frontiers.md) (Episode 6)  
**Comes from:** S4E05 Other Minds on Earth  
**Goes to:** S4E07 The Future of Earth's Climate  
...
1. Separate real ML capabilities from myth.
2. Distinguish intelligence from consciousness.
3. Introduce alignment and governance accessibly.
4. Link to human–machine coevolution and S3 networks.
5. Hand off to Earth climate futures.
...
**Cold open**  
A capability slider with speculation badges.

**Act I**  
Pattern learning, limits, and hype cycles.

**Act II**  
Performance is not automatically experience.

**Act III**  
Alignment, misuse, concentration of power — accessible.

**Act IV**  
Next: the planet's climate under human choice.
...
**Further depth / related:** S3E26–28; Earth futures arc opens at S4E07.

---

## Visual set-pieces

1. Tool → partner → unknown continuum
2. Capability vs consciousness split axes
3. Governance checklist (non-alarmist, non-naive)
